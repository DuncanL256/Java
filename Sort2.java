...
public class Sort2 {
    public static void main(String[] args) {
        ...
        System.out.println("regular mergesort took " + elapsed1 + " seconds");
        System.out.println();
        ...
        //THIRD METHOD'S CALL
        mergeSort2(list3);
        double elapsed3 = (System.currentTimeMillis() - start) / 1000.0;
        System.out.println("Marty's merge sort took " + elapsed3 + " seconds");
        System.out.println();
        

        //FOURTH METHOD'S CALL
        start = System.currentTimeMillis();
        selectionSort(list4);
        double elapsed4 = (System.currentTimeMillis() - start) / 1000.0;
        System.out.println("Selection sort took " + elapsed4 + " seconds");
        System.out.println();

        //FIFTH METHOD'S CALL
        start = System.currentTimeMillis();
        bubbleSort(list5);
        double elapsed5 = (System.currentTimeMillis() - start) / 1000.0;
        System.out.println("Bubble sort took " + elapsed5 + " seconds");
        System.out.println();
